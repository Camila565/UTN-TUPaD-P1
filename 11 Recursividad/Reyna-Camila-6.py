...
limite = int(input("Ingrese un número para ver los factoriales hasta ese valor: "))
...
limite = int(input("Ingrese la cantidad de términos de Fibonacci: "))
...
print("¿Es palíndromo?", palindromo(texto))
...
numero = int(input("Inrgese un número para sumar dígitos: "))
...
bloques = int(input("Cantidad de bloques en la base de la pirámide: "))
print("Total de bloques necesario: ", contar_bloques(bloques))
